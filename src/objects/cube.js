class Cube {
    ...
    initVertexBuffers(gl) {
        ...
        const colors = new Float32Array([     // Colors
            this.color[0], this.color[1], this.color[2],  // v0 front(user defined)
            this.color[0], this.color[1], this.color[2],  // v1 front(user defined)
            this.color[0], this.color[1], this.color[2],  // v2 front(user defined)
            this.color[0], this.color[1], this.color[2],  // v3 front(user defined)
